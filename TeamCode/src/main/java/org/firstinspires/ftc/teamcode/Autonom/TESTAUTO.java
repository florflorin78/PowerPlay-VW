...
import org.firstinspires.ftc.teamcode.RobotHardwareEssentials;
...
@Autonomous(name="OpModeTEST")
///@Disabled
public class TESTAUTO extends LinearOpMode  {

    public RobotHardwareEssentials robot = new RobotHardwareEssentials(hardwareMap);
