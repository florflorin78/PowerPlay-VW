...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(30, 0, 10, 13.9);
    ...
    public static double GEAR_RATIO = 1; // 0.9
    public static double TRACK_WIDTH = 13.97; // in
